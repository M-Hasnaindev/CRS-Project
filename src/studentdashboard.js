        ...
        <div className="page_3">
          <div className="bottom_section">
            <div className="section_4">
              <div className="data_here job_data" style={{ display: showCompany ? "block" : "none" }}>
                <h2>Job list</h2>
              ...
              <div className="data_here company_data" style={{ display: showCompany ? "none" : "block" }}>
                <h2>Company</h2>
                ...
                <div className="companies">
                    <div className="company" onClick={handlePageChange}>
                        ...
                        <p className="company_founded">Founded: <span>2020</span></p>
                        <p className="company_location">location: <span>Karachi, Pakistan</span></p>
                    </div>
                    <div className="company" onClick={handlePageChange}>
                        <img src={company2} alt="Company Image" width={"60%"} />
                        <h1 className="company_name">STATE LIFE</h1>
                        <p className="company_founded">Founded: <span>2002</span></p>
                        <p className="company_location">location: <span>Lahore, Pakistan</span></p>
                    </div>
                    <div className="company" onClick={handlePageChange}>
                        <img src={company3} alt="Company Image" width={"60%"} />
                        <h1 className="company_name">IT SOLUTION</h1>
                        <p className="company_founded">Founded: <span>2009</span></p>
                        <p className="company_location">location: <span>KPK, Pakistan</span></p>
                    </div>
                </div>
            </div>
              </div>
